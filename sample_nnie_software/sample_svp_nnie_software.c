    ...
    HI_U32 au32SoftMaxWidth[],HI_S32* aps32SoftMaxInputData[], HI_S32* ps32SoftMaxOutputData)
{
    ...
    //SAMPLE_SVP_TRACE_INFO("u32ConcatNum : %d\n",u32ConcatNum);
    for (u32ConcatCnt = 0; u32ConcatCnt < u32ConcatNum; u32ConcatCnt++)
    {
        ...
        //SAMPLE_SVP_TRACE_INFO("u32ConcatCnt : %d, u32OuterNum : %d\n",u32ConcatCnt,u32OuterNum);
    ...
    SAMPLE_SVP_NNIE_SSD_SOFTWARE_PARAM_S* pstSoftwareParam)
{
    ...
    //e=clock();
    //SAMPLE_SVP_TRACE_INFO("softmax : %f ms\n",1000*(float)(e-s)/CLOCKS_PER_SEC);
    ...
    //e=clock();
    //SAMPLE_SVP_TRACE_INFO("SoftmaxForward : %f ms\n",1000*(float)(e-s)/CLOCKS_PER_SEC);
    /*detection*/
    //s=clock();
    ...
    //e=clock();
    //SAMPLE_SVP_TRACE_INFO("detection : %f ms\n",1000*(float)(e-s)/CLOCKS_PER_SEC);
    ...
    (void)SVP_NNIE_Ssd_DetectionOutForward(pstSoftwareParam->u32ConcatNum,
        ...
        SAMPLE_SVP_NNIE_CONVERT_64BIT_ADDR(HI_S32,pstSoftwareParam->stClassRoiNum.u64VirAddr));
    //e=clock();
    //SAMPLE_SVP_TRACE_INFO("DetectionOutForward : %f ms\n",1000*(float)(e-s)/CLOCKS_PER_SEC);
